...
def run_episode(for_training):
    ...
    while not terminal:
        current_state_description = current_room_desc + current_quest_desc
        current_state_vector = utils.extract_bow_feature_vector(current_state_description, dictionary)
        ...
        if for_training:
            next_state_description = next_room_desc + next_quest_desc
            next_state_vector = utils.extract_bow_feature_vector(next_state_description,dictionary)
